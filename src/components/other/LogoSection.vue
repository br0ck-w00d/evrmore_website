...
import { ref } from 'vue'
import logoPackImage from '@/assets/logo_pack/logo_pack.svg'

const resourceItems = ref([
  {
    text: 'Logo Pack',
    image: logoPackImage,
    url: 'https://github.com/br0ck-w00d/Evrmore-Branding-Kit/tree/master/Evrmore_Logos'
  }
])
</script>
